...
var $author$project$PacMan$audioPortFromJS = _Platform_incomingPort('audioPortFromJS', $elm$json$Json$Decode$value);
var $elm$core$Basics$identity = function (x) {
	return x;
};
var $author$project$PacMan$audioPortToJS = _Platform_outgoingPort('audioPortToJS', $elm$core$Basics$identity);
		...
		return $elm$json$Json$Encode$object(
			_List_fromArray(
				[
					...
					_Utils_Tuple2(
					'startTime',
					$MartinSStewart$elm_audio$Audio$encodeTime(audio_.startTime)),
					_Utils_Tuple2(
					'startAt',
					...
					_Utils_Tuple2(
					'volumeTimelines',
					A2($elm$json$Json$Encode$list, $MartinSStewart$elm_audio$Audio$encodeVolumeTimeline, audio_.volumeTimelines)),
					_Utils_Tuple2(
					'loop',
...
var $MartinSStewart$elm_audio$Audio$flattenAudio = function (audio_) {
	switch (audio_.$) {
		...
		case 'BasicAudio':
			...
			return _List_fromArray(
				[
					{loop: settings.loop, playbackRate: settings.playbackRate, source: source, startAt: settings.startAt, startTime: startTime, volume: 1, volumeTimelines: _List_Nil}
				]);
		default:
			var effect = audio_.a;
...
var $MartinSStewart$elm_audio$Audio$updateAudioState = F2(
	function (_v0, _v1) {
		...
		var validAudio = A2(
			...
			function (_v7) {
				var a = _v7.b;
				return _Utils_eq(a.source, audioGroup.source) && (_Utils_eq(a.startTime, audioGroup.startTime) && _Utils_eq(a.startAt, audioGroup.startAt));
			},
			...
			A2(
				...
				A2(
					...
					function (_v1) {
						var index = _v1.a;
						var value = _v1.b;
						return A2($MartinSStewart$elm_audio$Audio$encodeAudioLoadRequest, model.requestCount + index, value);
					},
					newPendingRequests)));
	});
...
var $MartinSStewart$elm_audio$Audio$initHelper = F3(
	function (audioPort, audioFunc, _v0) {
		...
		var initialModel = $MartinSStewart$elm_audio$Audio$Model(
			{audioState: audioState, nodeGroupIdCounter: newNodeGroupIdCounter, pendingRequests: $elm$core$Dict$empty, requestCount: 0, samplesPerSecond: $elm$core$Maybe$Nothing, userModel: model});
...
var $MartinSStewart$elm_audio$Audio$MediaDecodeAudioDataUnknownContentType = {$: 'MediaDecodeAudioDataUnknownContentType'};
	...
	function (value) {
		switch (value) {
			...
			case 'MediaDecodeAudioDataUnknownContentType':
				return $elm$json$Json$Decode$succeed($MartinSStewart$elm_audio$Audio$MediaDecodeAudioDataUnknownContentType);
			default:
...
var $MartinSStewart$elm_audio$Audio$updateHelper = F4(
	function (audioPort, audioFunc, userUpdate, _v0) {
		var model = _v0.a;
		var _v1 = userUpdate(model.userModel);
...
var $author$project$PacMan$gameToAudio = function (game) {
	var _v0 = game.sound;
	if (_v0.$ === 'LoadedModel') {
		var x = _v0.a;
		var _v1 = x.soundState;
		switch (_v1.$) {
			case 'NotPlaying':
				return $MartinSStewart$elm_audio$Audio$silence;
			case 'Playing':
				var time = _v1.a;
				return A2($MartinSStewart$elm_audio$Audio$audio, x.sound, time);
			default:
				return $MartinSStewart$elm_audio$Audio$silence;
		}
	} else {
...
var $author$project$Types$GameModels$Blue = {$: 'Blue'};
var $author$project$Types$GameModels$LoadingModel = {$: 'LoadingModel'};
var $author$project$Types$GameModels$None = {$: 'None'};
...
var $author$project$Types$Line$Line = F3(
	function (start, end, linetype) {
		return {end: end, linetype: linetype, start: start};
	});
var $author$project$Settings$itemSettings = {fill: '#FFAAA5', size: 5, step: 15, xp: 10};
...
var $author$project$Eatable$moveToWards = F3(
	function (from, to, lenght) {
		return {
			x: from.x + A2($elm$core$Basics$min, lenght, to.x - from.x),
			y: from.y + A2($elm$core$Basics$min, lenght, to.y - from.y)
		};
	});
...
var $author$project$Eatable$createPoints = F2(
	function (line, pointList) {
		var startPoint = {
			x: A2($elm$core$Basics$min, line.start.x, line.end.x),
			y: A2($elm$core$Basics$min, line.start.y, line.end.y)
		};
		var endPoint = {
			x: A2($elm$core$Basics$max, line.start.x, line.end.x),
			y: A2($elm$core$Basics$max, line.start.y, line.end.y)
		};
		var currentPoint = A3($author$project$Eatable$moveToWards, startPoint, endPoint, $author$project$Settings$itemSettings.step);
		return _Utils_eq(line.linetype, $author$project$Types$Line$Both) ? ((!_Utils_eq(startPoint, endPoint)) ? A2(
			$elm$core$List$cons,
			startPoint,
			A2(
				$author$project$Eatable$createPoints,
				A3($author$project$Types$Line$Line, currentPoint, endPoint, line.linetype),
...
var $author$project$Types$Line$GhostStartLine = {$: 'GhostStartLine'};
var $author$project$Types$Line$Pacman = {$: 'Pacman'};
	...
	_List_fromArray(
		[
			...
			A3(
				...
				$author$project$Types$Line$Both)),
			_Utils_Tuple2(
			2,
			A3(
				$author$project$Types$Line$Line,
			...
			A3(
				...
				$author$project$Types$Line$Pacman)),
			_Utils_Tuple2(
			22,
			A3(
				$author$project$Types$Line$Line,
			...
			A3(
				...
				$author$project$Types$Line$GhostStartLine)),
			_Utils_Tuple2(
			49,
			A3(
				$author$project$Types$Line$Line,
...
var $author$project$PacMan$substractList = F2(
	function (a, b) {
		return A2(
			$elm$core$List$filter,
			function (x) {
...
var $MartinSStewart$elm_audio$Audio$enumeratedResults = A2(
	...
	_Utils_ap(
		_List_fromArray(
			[
				$elm$core$Result$Err($MartinSStewart$elm_audio$Audio$MediaDecodeAudioDataUnknownContentType),
...
var $author$project$PacMan$init = function (_v0) {
	return _Utils_Tuple3(
		$author$project$PacMan$initialModel,
		$elm$core$Platform$Cmd$none,
		A2($MartinSStewart$elm_audio$Audio$loadAudio, $author$project$Types$GameModels$SoundLoaded, 'https://cors-anywhere.herokuapp.com/https://freepd.com/music/Wakka%20Wakka.mp3'));
};
var $author$project$Types$GameModels$Fruit = {$: 'Fruit'};
var $author$project$Types$GameModels$GhostMove = {$: 'GhostMove'};
...
var $author$project$Types$GameModels$Down = {$: 'Down'};
var $author$project$Types$GameModels$Left = {$: 'Left'};
var $author$project$Types$GameModels$Nothing = {$: 'Nothing'};
var $author$project$PacMan$toKey = function (string) {
	switch (string) {
		case 'ArrowUp':
			return $author$project$Types$GameModels$ChangeDirection($author$project$Types$GameModels$Up);
		case 'ArrowDown':
			return $author$project$Types$GameModels$ChangeDirection($author$project$Types$GameModels$Down);
		case 'ArrowLeft':
			return $author$project$Types$GameModels$ChangeDirection($author$project$Types$GameModels$Left);
		case 'ArrowRight':
			return $author$project$Types$GameModels$ChangeDirection($author$project$Types$GameModels$Right);
		default:
			return $author$project$Types$GameModels$Nothing;
	}
};
var $author$project$PacMan$keyDecoder = A2(
	$elm$json$Json$Decode$map,
	$author$project$PacMan$toKey,
...
var $author$project$PacMan$subscriptions = function (game) {
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
...
var $author$project$Types$GameModels$GetCurrentTime = F2(
	function (a, b) {
		return {$: 'GetCurrentTime', a: a, b: b};
	});
var $author$project$Types$GameModels$LoadFailedModel = {$: 'LoadFailedModel'};
...
var $author$project$PacMan$changeYPosition = F2(
	function (value, game) {
		var oldPosition = game.pPosition;
		return _Utils_update(
			oldPosition,
...
var $author$project$Movement$checkPath = F4(
	function (pos, lType, line, e) {
		return ((_Utils_cmp(
			pos.x,
			A2($elm$core$Basics$min, line.start.x, line.end.x)) > -1) && ((_Utils_cmp(
			pos.x,
			A2($elm$core$Basics$max, line.start.x, line.end.x)) < 1) && ((_Utils_cmp(
			pos.y,
			A2($elm$core$Basics$min, line.start.y, line.end.y)) > -1) && ((_Utils_cmp(
			pos.y,
			A2($elm$core$Basics$max, line.start.y, line.end.y)) < 1) && (_Utils_eq(line.linetype, lType) || _Utils_eq(line.linetype, $author$project$Types$Line$Both)))))) || e;
	});
var $author$project$Movement$getMesh = F3(
	function (mesh, pos, ghost) {
		return A3(
			$elm$core$List$foldl,
			A2(
				F2(
...
var $author$project$Movement$checkDir = F3(
	function (point, dir, ghost) {
		switch (dir.$) {
			case 'Left':
				return A3(
					$author$project$Movement$getMesh,
					$author$project$Settings$runMesh,
					{x: point.x - $author$project$Settings$movement, y: point.y},
					ghost);
			case 'Right':
				return A3(
					$author$project$Movement$getMesh,
			...
			case 'Up':
				return A3(
					$author$project$Movement$getMesh,
					$author$project$Settings$runMesh,
					{x: point.x, y: point.y - $author$project$Settings$movement},
					ghost);
			case 'Down':
				return A3(
					$author$project$Movement$getMesh,
...
var $author$project$Settings$pillSettings = {fill: '#FFAAA5', radius: 6, xp: 50};
var $author$project$Eatable$checkEatable = function (game) {
	...
	var localListItems = checkCurrentPoint(game.items);
	var localListPills = checkCurrentPoint(game.pills);
	return (_Utils_eq(
		$elm$core$List$length(game.pills),
		$elm$core$List$length(localListPills)) && _Utils_eq(
		$elm$core$List$length(game.items),
		$elm$core$List$length(localListItems))) ? ((_Utils_eq(game.pPosition, $author$project$Settings$fruitSettings.position) && game.fruitAvailable) ? _Utils_update(
		game,
		{fruitAvailable: false, score: game.score + $author$project$Settings$fruitSettings.xp}) : game) : ((!_Utils_eq(
		$elm$core$List$length(game.pills),
		...
		game,
		{fruitAvailable: true, itemCounter: game.itemCounter + 1, items: localListItems, score: game.score + $author$project$Settings$itemSettings.xp}) : _Utils_update(
		game,
...
var $author$project$Settings$fieldSettings = {borderColor: '#3498DB', height: 500, width: 500};
var $author$project$Types$Line$Ghost = {$: 'Ghost'};
...
var $author$project$Types$Ghost$getVectorLength = F2(
	function (p1, p2) {
		var dv = {x: p1.x - p2.x, y: p1.y - p2.y};
		return $lynn$elm_arithmetic$Arithmetic$intSquareRoot((dv.x * dv.x) + (dv.y * dv.y));
	});
...
var $author$project$Types$Ghost$getNextCross = F2(
	function (pos, dir) {
		getNextCross:
		while (true) {
			if ((A3($author$project$Movement$checkDir, pos, dir, $author$project$Types$Line$Ghost) && ((!A3($author$project$Movement$checkDir, pos, $author$project$Types$GameModels$Right, $author$project$Types$Line$Ghost)) && ((!A3($author$project$Movement$checkDir, pos, $author$project$Types$GameModels$Up, $author$project$Types$Line$Ghost)) && (!A3($author$project$Movement$checkDir, pos, $author$project$Types$GameModels$Down, $author$project$Types$Line$Ghost))))) || (((!A3($author$project$Movement$checkDir, pos, $author$project$Types$GameModels$Left, $author$project$Types$Line$Ghost)) && ((!A3($author$project$Movement$checkDir, pos, $author$project$Types$GameModels$Right, $author$project$Types$Line$Ghost)) && (!A3($author$project$Movement$checkDir, pos, $author$project$Types$GameModels$Down, $author$project$Types$Line$Ghost)))) || (((!A3($author$project$Movement$checkDir, pos, $author$project$Types$GameModels$Left, $author$project$Types$Line$Ghost)) && ((!A3($author$project$Movement$checkDir, pos, $author$project$Types$GameModels$Up, $author$project$Types$Line$Ghost)) && (!A3($author$project$Movement$checkDir, pos, $author$project$Types$GameModels$Down, $author$project$Types$Line$Ghost)))) || ((!A3($author$project$Movement$checkDir, pos, $author$project$Types$GameModels$Left, $author$project$Types$Line$Ghost)) && ((!A3($author$project$Movement$checkDir, pos, $author$project$Types$GameModels$Right, $author$project$Types$Line$Ghost)) && (!A3($author$project$Movement$checkDir, pos, $author$project$Types$GameModels$Up, $author$project$Types$Line$Ghost))))))) {
				switch (dir.$) {
					case 'Left':
						var $temp$pos = {x: pos.x + $author$project$Settings$movement, y: pos.y},
							$temp$dir = dir;
						pos = $temp$pos;
						dir = $temp$dir;
					...
					case 'Right':
						...
						continue getNextCross;
					case 'Down':
						var $temp$pos = {x: pos.x, y: pos.y + $author$project$Settings$movement},
							$temp$dir = dir;
						pos = $temp$pos;
						dir = $temp$dir;
						continue getNextCross;
...
var $author$project$Types$Ghost$getGhostNextDir = F2(
	function (game, ghost) {
		...
		var targetPos = function () {
			if (_Utils_eq(ghost.ghostColor, $author$project$Types$GameModels$Yellow) && ((_Utils_cmp(
				A2($author$project$Types$Ghost$getVectorLength, ghost.position, game.pPosition),
				8 * $author$project$Settings$pacSettings.ratio) > 0) && (!_Utils_eq(currentType, $author$project$Types$Line$GhostStartLine)))) {
				return $author$project$Settings$getPoint(44);
			} else {
				if (!ghost.active) {
					return $author$project$Settings$ghostSettings.startPosition;
				} else {
					var _v0 = game.state;
					if (_v0.$ === 'Running') {
						var dir = _v0.a;
						switch (dir.$) {
							case 'Left':
								var pos = {x: game.pPosition.x - (ghost.offset * $author$project$Settings$pacSettings.ratio), y: game.pPosition.y};
								return _Utils_eq(ghost.ghostColor, $author$project$Types$GameModels$Blue) ? {
									x: game.pPosition.x - A2($author$project$Types$Ghost$getBlueGhoastOffset, game.redGhost.position, pos),
									y: game.pPosition.y
								} : pos;
							case 'Right':
								var pos = {x: game.pPosition.x + (ghost.offset * $author$project$Settings$pacSettings.ratio), y: game.pPosition.y};
							...
							case 'Down':
								var pos = {x: game.pPosition.x, y: game.pPosition.y + (ghost.offset * $author$project$Settings$pacSettings.ratio)};
								return _Utils_eq(ghost.ghostColor, $author$project$Types$GameModels$Blue) ? {
									x: game.pPosition.x,
									y: game.pPosition.y + A2($author$project$Types$Ghost$getBlueGhoastOffset, game.redGhost.position, pos)
								} : pos;
							case 'Up':
								var pos = {x: game.pPosition.x, y: game.pPosition.y - (ghost.offset * $author$project$Settings$pacSettings.ratio)};
								return _Utils_eq(ghost.ghostColor, $author$project$Types$GameModels$Blue) ? {
		...
		if (_Utils_eq(ghost.dir, $author$project$Types$GameModels$None) || (((_Utils_eq(ghost.dir, $author$project$Types$GameModels$Left) || _Utils_eq(ghost.dir, $author$project$Types$GameModels$Right)) && (A3($author$project$Movement$checkDir, ghost.position, $author$project$Types$GameModels$Up, currentType) || A3($author$project$Movement$checkDir, ghost.position, $author$project$Types$GameModels$Down, currentType))) || ((_Utils_eq(ghost.dir, $author$project$Types$GameModels$Up) || _Utils_eq(ghost.dir, $author$project$Types$GameModels$Down)) && (A3($author$project$Movement$checkDir, ghost.position, $author$project$Types$GameModels$Left, currentType) || A3($author$project$Movement$checkDir, ghost.position, $author$project$Types$GameModels$Right, currentType))))) {
			var yDif = A2($elm$core$Basics$max, targetPos.y, ghost.position.y) - A2($elm$core$Basics$min, targetPos.y, ghost.position.y);
			var xDif = A2($elm$core$Basics$max, targetPos.x, ghost.position.x) - A2($elm$core$Basics$min, targetPos.x, ghost.position.x);
			var nextVerticalCross = (_Utils_cmp(
				A2(
					$author$project$Types$Ghost$getVectorLength,
					A2($author$project$Types$Ghost$getNextCross, ghost.position, $author$project$Types$GameModels$Up),
					targetPos),
				A2(
					$author$project$Types$Ghost$getVectorLength,
					A2($author$project$Types$Ghost$getNextCross, ghost.position, $author$project$Types$GameModels$Down),
					targetPos)) > 0) ? $author$project$Types$GameModels$Up : $author$project$Types$GameModels$Down;
			var nextHorizontalCross = (_Utils_cmp(
				A2(
					$author$project$Types$Ghost$getVectorLength,
					A2($author$project$Types$Ghost$getNextCross, ghost.position, $author$project$Types$GameModels$Left),
					targetPos),
				A2(
					$author$project$Types$Ghost$getVectorLength,
					A2($author$project$Types$Ghost$getNextCross, ghost.position, $author$project$Types$GameModels$Right),
					targetPos)) > 0) ? $author$project$Types$GameModels$Left : $author$project$Types$GameModels$Right;
			var moveOptions = ((_Utils_cmp(targetPos.x, ghost.position.x) > 0) && (_Utils_cmp(targetPos.y, ghost.position.y) > 0)) ? {cHorizontal: $author$project$Types$GameModels$Left, cVertical: $author$project$Types$GameModels$Up, horizontal: $author$project$Types$GameModels$Right, vertical: $author$project$Types$GameModels$Down} : (((_Utils_cmp(targetPos.x, ghost.position.x) > 0) && (_Utils_cmp(targetPos.y, ghost.position.y) < 0)) ? {cHorizontal: $author$project$Types$GameModels$Left, cVertical: $author$project$Types$GameModels$Down, horizontal: $author$project$Types$GameModels$Right, vertical: $author$project$Types$GameModels$Up} : (((_Utils_cmp(targetPos.x, ghost.position.x) < 0) && (_Utils_cmp(targetPos.y, ghost.position.y) < 0)) ? {cHorizontal: $author$project$Types$GameModels$Right, cVertical: $author$project$Types$GameModels$Down, horizontal: $author$project$Types$GameModels$Left, vertical: $author$project$Types$GameModels$Up} : (((_Utils_cmp(targetPos.x, ghost.position.x) < 0) && (_Utils_cmp(targetPos.y, ghost.position.y) > 0)) ? {cHorizontal: $author$project$Types$GameModels$Right, cVertical: $author$project$Types$GameModels$Up, horizontal: $author$project$Types$GameModels$Left, vertical: $author$project$Types$GameModels$Down} : (_Utils_eq(targetPos.x, ghost.position.x) ? ((_Utils_cmp(targetPos.y, ghost.position.y) > 0) ? {cHorizontal: nextHorizontalCross, cVertical: $author$project$Types$GameModels$Up, horizontal: nextHorizontalCross, vertical: $author$project$Types$GameModels$Down} : {cHorizontal: nextHorizontalCross, cVertical: $author$project$Types$GameModels$Down, horizontal: nextHorizontalCross, vertical: $author$project$Types$GameModels$Up}) : (_Utils_eq(targetPos.y, ghost.position.y) ? ((_Utils_cmp(targetPos.x, ghost.position.x) > 0) ? {cHorizontal: $author$project$Types$GameModels$Left, cVertical: nextVerticalCross, horizontal: $author$project$Types$GameModels$Right, vertical: nextVerticalCross} : {cHorizontal: $author$project$Types$GameModels$Right, cVertical: nextVerticalCross, horizontal: $author$project$Types$GameModels$Left, vertical: nextVerticalCross}) : {cHorizontal: $author$project$Types$GameModels$None, cVertical: $author$project$Types$GameModels$None, horizontal: $author$project$Types$GameModels$None, vertical: $author$project$Types$GameModels$None})))));
			if ((A3($author$project$Movement$checkDir, ghost.position, moveOptions.horizontal, currentType) && (!_Utils_eq(ghost.dir, moveOptions.cHorizontal))) && (A3($author$project$Movement$checkDir, ghost.position, moveOptions.vertical, currentType) && (!_Utils_eq(ghost.dir, moveOptions.cVertical)))) {
				return (_Utils_cmp(xDif, yDif) < 0) ? moveOptions.vertical : moveOptions.horizontal;
			} else {
				if (A3($author$project$Movement$checkDir, ghost.position, moveOptions.horizontal, currentType) && (!_Utils_eq(ghost.dir, moveOptions.cHorizontal))) {
					return moveOptions.horizontal;
				} else {
					if (A3($author$project$Movement$checkDir, ghost.position, moveOptions.vertical, currentType) && (!_Utils_eq(ghost.dir, moveOptions.cVertical))) {
						return moveOptions.vertical;
					} else {
						if ((A3($author$project$Movement$checkDir, ghost.position, moveOptions.cHorizontal, currentType) && (!_Utils_eq(ghost.dir, moveOptions.horizontal))) && (A3($author$project$Movement$checkDir, ghost.position, moveOptions.cVertical, currentType) && (!_Utils_eq(ghost.dir, moveOptions.vertical)))) {
							var verticalNextCross = A2($author$project$Types$Ghost$getNextCross, ghost.position, moveOptions.cVertical);
							var horizontalNextCross = A2($author$project$Types$Ghost$getNextCross, ghost.position, moveOptions.cHorizontal);
							return (_Utils_cmp(
								A2($author$project$Types$Ghost$getVectorLength, verticalNextCross, targetPos),
								A2($author$project$Types$Ghost$getVectorLength, horizontalNextCross, targetPos)) < 0) ? moveOptions.cVertical : moveOptions.cHorizontal;
						} else {
							if (A3($author$project$Movement$checkDir, ghost.position, moveOptions.cHorizontal, currentType) && (!_Utils_eq(ghost.dir, moveOptions.horizontal))) {
								return moveOptions.cHorizontal;
							} else {
								if (A3($author$project$Movement$checkDir, ghost.position, moveOptions.cVertical, currentType) && (!_Utils_eq(ghost.dir, moveOptions.vertical))) {
									return moveOptions.cVertical;
								} else {
									return $author$project$Types$GameModels$None;
								}
							}
						}
					}
...
var $author$project$Types$Ghost$moveGhost = F2(
	function (ghost, dir) {
		var ghostNextPos = function () {
			switch (dir.$) {
				case 'Left':
					return {x: ghost.position.x - $author$project$Settings$movement, y: ghost.position.y};
				case 'Right':
					return {x: ghost.position.x + $author$project$Settings$movement, y: ghost.position.y};
				case 'Up':
					return {x: ghost.position.x, y: ghost.position.y - $author$project$Settings$movement};
				case 'Down':
					return {x: ghost.position.x, y: ghost.position.y + $author$project$Settings$movement};
				default:
		...
		var activeState = (!ghost.active) ? ((!ghost.active) && _Utils_eq(ghostNextPos, $author$project$Settings$ghostSettings.startPosition)) : ghost.active;
		return {active: activeState, dir: dir, ghostColor: ghost.ghostColor, offset: ghost.offset, position: ghostNextPos};
	});
							...
							if ($author$project$Movement$outOfBounds(game)) {
								return _Utils_Tuple3(
									_Utils_update(
										game,
										{
											pPosition: A2($author$project$PacMan$changeXPosition, $author$project$Settings$fieldSettings.width, game),
											pRotation: 180,
								...
								if (A3($author$project$Movement$checkDir, game.pPosition, d, $author$project$Types$Line$Pacman) || A3($author$project$Movement$checkDir, game.pPosition, game.nextDir, $author$project$Types$Line$Pacman)) {
									return (A3($author$project$Movement$checkDir, game.pPosition, game.nextDir, $author$project$Types$Line$Pacman) && (!_Utils_eq(game.nextDir, d))) ? _Utils_Tuple3(
										_Utils_update(
											game,
											{
												nextDir: $author$project$Types$GameModels$None,
												state: $author$project$Types$GameModels$Running(game.nextDir)
											}),
										$elm$core$Platform$Cmd$none,
										...
										$author$project$Eatable$checkEatable(
											_Utils_update(
												game,
												{
													pPosition: A2($author$project$PacMan$changeXPosition, game.pPosition.x - $author$project$Settings$movement, game),
													pRotation: 180,
													state: $author$project$Types$GameModels$Running(d)
												})),
										$elm$core$Platform$Cmd$none,
									...
									var $temp$msg = $author$project$Types$GameModels$NoMoving,
										$temp$game = game;
									msg = $temp$msg;
									game = $temp$game;
									continue update;
							...
							if ($author$project$Movement$outOfBounds(game)) {
								return _Utils_Tuple3(
									_Utils_update(
										game,
										{
											pPosition: A2($author$project$PacMan$changeXPosition, 0, game),
											pRotation: 0,
											state: $author$project$Types$GameModels$Running(d)
										}),
									$elm$core$Platform$Cmd$none,
							...
							if ($author$project$Movement$outOfBounds(game)) {
								return _Utils_Tuple3(
									_Utils_update(
										game,
										{
											pPosition: A2($author$project$PacMan$changeYPosition, $author$project$Settings$fieldSettings.height, game),
											pRotation: -90,
											state: $author$project$Types$GameModels$Running(d)
										}),
									$elm$core$Platform$Cmd$none,
									...
									return (A3($author$project$Movement$checkDir, game.pPosition, game.nextDir, $author$project$Types$Line$Pacman) && (!_Utils_eq(game.nextDir, d))) ? _Utils_Tuple3(
										...
										$author$project$Eatable$checkEatable(
											_Utils_update(
												game,
												{
													pPosition: A2($author$project$PacMan$changeYPosition, game.pPosition.y - $author$project$Settings$movement, game),
													pRotation: -90,
													state: $author$project$Types$GameModels$Running(d)
												})),
										$elm$core$Platform$Cmd$none,
							...
							if ($author$project$Movement$outOfBounds(game)) {
								return _Utils_Tuple3(
									_Utils_update(
										game,
										{
											pPosition: A2($author$project$PacMan$changeYPosition, 0, game),
											pRotation: 90,
											state: $author$project$Types$GameModels$Running(d)
										}),
									$elm$core$Platform$Cmd$none,
				...
				case 'GhostMove':
					if (A2($author$project$Types$Ghost$checkGhoastEatingPacMan, game.pPosition, game.redGhost.position) && (A2($author$project$Types$Ghost$checkGhoastEatingPacMan, game.pPosition, game.blueGhost.position) && (A2($author$project$Types$Ghost$checkGhoastEatingPacMan, game.pPosition, game.yellowGhost.position) && (A2($author$project$Types$Ghost$checkGhoastEatingPacMan, game.pPosition, game.pinkGhost.position) && (!_Utils_eq(
						...
						return (game.itemCounter > 91) ? _Utils_Tuple3(
							_Utils_update(
								game,
								{
									blueGhost: A2(
										...
										game.blueGhost,
										A2($author$project$Types$Ghost$getGhostNextDir, game, game.blueGhost)),
									pinkGhost: A2(
										$author$project$Types$Ghost$moveGhost,
										game.pinkGhost,
										A2($author$project$Types$Ghost$getGhostNextDir, game, game.pinkGhost)),
									redGhost: A2(
										$author$project$Types$Ghost$moveGhost,
										game.redGhost,
										A2($author$project$Types$Ghost$getGhostNextDir, game, game.redGhost)),
									yellowGhost: A2(
										$author$project$Types$Ghost$moveGhost,
										game.yellowGhost,
										A2($author$project$Types$Ghost$getGhostNextDir, game, game.yellowGhost))
								}),
							$elm$core$Platform$Cmd$none,
							$MartinSStewart$elm_audio$Audio$cmdNone) : ((game.itemCounter > 31) ? _Utils_Tuple3(
							_Utils_update(
								game,
								{
									blueGhost: A2(
							...
							$elm$core$Platform$Cmd$none,
							$MartinSStewart$elm_audio$Audio$cmdNone) : ((game.itemCounter > 1) ? _Utils_Tuple3(
							_Utils_update(
								game,
								{
									pinkGhost: A2(
				...
				default:
					...
					return _Utils_Tuple3(
						_Utils_update(
							game,
							{
								sound: $author$project$Types$GameModels$LoadedModel(
									{
										sound: sound,
										soundState: $author$project$Types$GameModels$Playing(posix)
									})
							}),
						$elm$core$Platform$Cmd$none,
						$MartinSStewart$elm_audio$Audio$cmdNone);
...
var $author$project$Eatable$createFruit = function (available) {
	return available ? _List_fromArray(
		[
			...
			_List_fromArray(
				[
					$elm$svg$Svg$Attributes$xlinkHref('Assets/img/fruits/cherry.svg'),
					$elm$svg$Svg$Attributes$width(
					$elm$core$String$fromInt($author$project$Settings$fruitSettings.ratio)),
					$elm$svg$Svg$Attributes$height(
					$elm$core$String$fromInt($author$project$Settings$fruitSettings.ratio)),
					$elm$svg$Svg$Attributes$x(
					$elm$core$String$fromInt(
						$author$project$Settings$fruitSettings.position.x - $elm$core$Basics$round($author$project$Settings$fruitSettings.ratio / 2))),
					$elm$svg$Svg$Attributes$y(
					$elm$core$String$fromInt(
						$author$project$Settings$fruitSettings.position.y - $elm$core$Basics$round($author$project$Settings$fruitSettings.ratio / 2)))
				]),
			_List_Nil)
		]) : _List_Nil;
};
...
var $author$project$Style$gameChildCss = _List_fromArray(
	[
		...
		'width',
		$elm$core$String$fromInt($author$project$Settings$fieldSettings.width) + 'px'),
		A2(
		$elm$html$Html$Attributes$style,
		'height',
		$elm$core$String$fromInt($author$project$Settings$fieldSettings.height) + 'px'),
...
var $author$project$Style$ghostSvgCss = _List_fromArray(
	[
		...
		$elm$html$Html$Attributes$style,
		'width',
		$elm$core$String$fromInt($author$project$Settings$ghostSettings.ratio) + 'px'),
		A2(
		$elm$html$Html$Attributes$style,
		'height',
		$elm$core$String$fromInt($author$project$Settings$ghostSettings.ratio) + 'px')
...
var $author$project$Style$pacmanSvgCss = _List_fromArray(
	[
		...
		$elm$html$Html$Attributes$style,
		'width',
		$elm$core$String$fromInt($author$project$Settings$pacSettings.ratio) + 'px'),
		A2(
		$elm$html$Html$Attributes$style,
		'height',
		$elm$core$String$fromInt($author$project$Settings$pacSettings.ratio) + 'px')
		...
		return A2(
			...
			_List_fromArray(
				[
					$elm$svg$Svg$Attributes$x(
					$elm$core$String$fromInt(
						point.x - $elm$core$Basics$round($author$project$Settings$itemSettings.size / 2))),
					$elm$svg$Svg$Attributes$y(
					$elm$core$String$fromInt(
						point.y - $elm$core$Basics$round($author$project$Settings$itemSettings.size / 2))),
					$elm$svg$Svg$Attributes$width(
					$elm$core$String$fromInt($author$project$Settings$itemSettings.size)),
					$elm$svg$Svg$Attributes$height(
					$elm$core$String$fromInt($author$project$Settings$itemSettings.size)),
					$elm$svg$Svg$Attributes$fill($author$project$Settings$itemSettings.fill)
				]),
			_List_Nil);
	});
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					$elm$core$String$fromInt($author$project$Settings$pillSettings.radius)),
					$elm$svg$Svg$Attributes$fill($author$project$Settings$pillSettings.fill)
				]),
			_List_Nil);
	});
...
var $author$project$PacMan$view = function (game) {
	return A3(
		$elm$html$Html$node,
		'main',
		_List_Nil,
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text(
										$elm$core$String$fromInt(game.score))
									])),
								A2(
								$elm$html$Html$div,
								$author$project$Style$textCss,
						...
						_List_fromArray(
							[
								...
								_Utils_ap(
									A2($author$project$Eatable$pointsToSvg, game.items, 1),
									_Utils_ap(
										A2($author$project$Eatable$pointsToSvg, game.pills, 2),
										_Utils_ap(
											$author$project$Eatable$createFruit(game.fruitAvailable),
											_List_fromArray(
												[
													A2(
													$elm$svg$Svg$path,
													_List_fromArray(
														[
															$elm$svg$Svg$Attributes$fill($author$project$Settings$fieldSettings.borderColor),
										...
										_Utils_ap(
											...
											_List_fromArray(
												[
													...
													'top',
													$elm$core$String$fromInt(
														game.pPosition.y - $elm$core$Basics$round($author$project$Settings$pacSettings.ratio / 2)) + 'px'),
													A2(
													$elm$html$Html$Attributes$style,
													'left',
													$elm$core$String$fromInt(
														game.pPosition.x - $elm$core$Basics$round($author$project$Settings$pacSettings.ratio / 2)) + 'px'),
													A2(
													$elm$html$Html$Attributes$style,
													'transform',
								...
								_List_fromArray(
									[
										...
										_Utils_ap(
											...
											_List_fromArray(
												[
													$elm$html$Html$Attributes$src('Assets/img/ghosts/blinky.svg'),
													A2(
													$elm$html$Html$Attributes$style,
													'top',
													$elm$core$String$fromInt(
														game.redGhost.position.y - $elm$core$Basics$round($author$project$Settings$ghostSettings.ratio / 2)) + 'px'),
													A2(
													$elm$html$Html$Attributes$style,
													'left',
													$elm$core$String$fromInt(
														game.redGhost.position.x - $elm$core$Basics$round($author$project$Settings$ghostSettings.ratio / 2)) + 'px')
												])),
										_List_Nil),
										A2(
										$elm$html$Html$img,
										_Utils_ap(
											...
											_List_fromArray(
												[
													$elm$html$Html$Attributes$src('Assets/img/ghosts/pinky.svg'),
													A2(
													$elm$html$Html$Attributes$style,
													'top',
													$elm$core$String$fromInt(
														game.pinkGhost.position.y - $elm$core$Basics$round($author$project$Settings$ghostSettings.ratio / 2)) + 'px'),
													A2(
													$elm$html$Html$Attributes$style,
													'left',
													$elm$core$String$fromInt(
														game.pinkGhost.position.x - $elm$core$Basics$round($author$project$Settings$ghostSettings.ratio / 2)) + 'px')
												])),
										_List_Nil),
										A2(
										$elm$html$Html$img,
										_Utils_ap(
											...
											_List_fromArray(
												[
													$elm$html$Html$Attributes$src('Assets/img/ghosts/inky.svg'),
													A2(
													$elm$html$Html$Attributes$style,
													'top',
													$elm$core$String$fromInt(
														game.blueGhost.position.y - $elm$core$Basics$round($author$project$Settings$ghostSettings.ratio / 2)) + 'px'),
													A2(
													$elm$html$Html$Attributes$style,
													'left',
													$elm$core$String$fromInt(
														game.blueGhost.position.x - $elm$core$Basics$round($author$project$Settings$ghostSettings.ratio / 2)) + 'px')
												])),
										_List_Nil),
										A2(
										$elm$html$Html$img,
										_Utils_ap(
											...
											_List_fromArray(
												[
													$elm$html$Html$Attributes$src('Assets/img/ghosts/clyde.svg'),
													A2(
													$elm$html$Html$Attributes$style,
													'top',
													$elm$core$String$fromInt(
														game.yellowGhost.position.y - $elm$core$Basics$round($author$project$Settings$ghostSettings.ratio / 2)) + 'px'),
													A2(
													$elm$html$Html$Attributes$style,
													'left',
													$elm$core$String$fromInt(
														game.yellowGhost.position.x - $elm$core$Basics$round($author$project$Settings$ghostSettings.ratio / 2)) + 'px')
												])),
										_List_Nil)
									]))
							])),
									...
									[
										...
										_List_fromArray(
											[
												...
												$elm$html$Html$Attributes$width($author$project$Settings$fruitSettings.ratio),
												$elm$html$Html$Attributes$height($author$project$Settings$fruitSettings.ratio)
											]),
										_List_Nil),
										A2(
										$elm$html$Html$img,
...
var $author$project$PacMan$main = $MartinSStewart$elm_audio$Audio$elementWithAudio(
	{
		audio: $author$project$PacMan$gameToAudio,
		audioPort: {fromJS: $author$project$PacMan$audioPortFromJS, toJS: $author$project$PacMan$audioPortToJS},
		init: $author$project$PacMan$init,
		subscriptions: $author$project$PacMan$subscriptions,
		update: $author$project$PacMan$update,
		view: $author$project$PacMan$view
	});
_Platform_export({'PacMan':{'init':$author$project$PacMan$main(
